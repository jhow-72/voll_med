...
import med.voll.api.domain.consulta.SituacaoConsulta;
...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioPorEspecialidadeLivreNaDataCenario1() {
        ...
        var medico = cadastrarMedico("Medico", "meidoc@voll.med", "123456", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Paciente", "paciente@email.com", "11111111111");
    ...
    private void cadastrarConsulta(Medico medico, Paciente paciente, LocalDateTime data){
        em.persist(new Consulta(null, medico, paciente, data, SituacaoConsulta.AGENDADA, MotivoCancelamento.NA));
    }
